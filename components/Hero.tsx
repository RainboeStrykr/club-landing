  ...
  return (
    <div className="relative w-full lg:min-h-[calc(100vh)] h-fit flex bg-black">
      <div className="w-full h-auto flex-grow m-4 sm:m-8 rounded-3xl lg:rounded-[3rem] relative hero-gradient flex flex-col overflow-hidden">
        ...
        <div className="font-sans text-center font-extrabold text-[30vw] xl:text-[400px] opacity-[12%] text-zinc-50 absolute -bottom-4 sm:-bottom-8 md:-bottom-12 w-full leading-none pointer-events-none">HRCC</div>
        <div className="font-sans text-center font-extrabold text-[30vw] xl:text-[400px] opacity-[3%] text-zinc-50 absolute -bottom-4 sm:-bottom-8 md:-bottom-12 w-full leading-none pointer-events-none z-20">HRCC</div>
        <BackgroundBeams />
      </div>
